...
/**
 * S2 Slider slider edit form slides tab slide item
 *
 * @category    S2
 * @package     S2_Slider
 * @author      S2 FED Team
 */
class S2_Slider_Block_Adminhtml_Slider_Edit_Tab_Slides_Slide extends Mage_Adminhtml_Block_Widget
{
    /**
     * @var
     */
    ...
    {
        parent::__construct();
        $this->setTemplate('s2/slider/slides/slide.phtml');
    }
     ...
     *
     * @param $itemCount
     * @return S2_Slider_Block_Adminhtml_Slider_Edit_Tab_Slides_Slide
     */
