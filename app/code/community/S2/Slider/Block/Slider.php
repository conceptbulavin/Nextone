...
/**
 * S2 Slider slider block
 *
 * @category    S2
 * @package     S2_Slider
 * @author      S2 FED Team
 */
class S2_Slider_Block_Slider extends Mage_Core_Block_Template implements Mage_Widget_Block_Interface
{
    /**
     * @var
     */
    ...
    public function getTemplate()
    {
        if (!$this->hasData('template')) {
            $this->setData('template', 's2/slider/slider.phtml');
        }
    ...
    public function getJson()
    {
        ...
        foreach($this->getSlides() as $slide){
            ...
            $slideObj->src = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_MEDIA) . DS . 's2slider' . DS . $slide['image'];
